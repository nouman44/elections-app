...
public class Voter {
    ...
    public Voter(String silsilaNumber, String gharanaNumber, String name, String fatherName, int age, String address, String blockCode, String phoneNo, String cnic, int serialNo) {
